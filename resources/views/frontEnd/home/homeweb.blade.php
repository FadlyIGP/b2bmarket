                    ...
                    <table class="table" width="100%">
                        <tr>
                            <td width="25%" style="font-size: 12px">
                                <a href="{{url('infoproducts')}}" style="color: black">
                                    Semua Kategori
                                </a>
...
<div id="services" class="services section " style="padding-bottom: -100000000px">
    <div class="container">
        ...
        <div class="col-lg-12" style="padding-top: 5px;padding-right: 5px;padding-left: 5px">
            <a href="{{ url('/infoproducts') }}" class="next">More &raquo;</a>
        </div>
    </div>
