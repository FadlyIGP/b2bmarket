            ...
            <div style="border: 1px solid #969696;border-radius: 10px;">
              ...
              <div id="Paris" class="tabcontent">
                {{-- <h3>Paris</h3>
                  ...
                  <div class="form-group">
                    <div class="col-sm-10">
                      <input type="hidden" class="form-control" id="id_email" name="email" value="{{ $profile->email}}" required>
                    </div>
                  </div>
                  <div class="form-group" id="rata">
                    <label class="col-sm-2 control-label">New Password</label>
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="idnew_pass" name="new_pass" placeholder="New Password" onblur="checkLength1(this)" required>
                  ...
                  <div class="form-group" id="rata">
                    ...
                    <div class="col-sm-10">
                      <input type="password" class="form-control" id="idconfirm_pass" name="confirm_pass">
...
<script>
  function validateForm(form){
    ...
    var checkPass = document.getElementById('idconfirm_pass').value;
